...
create_clock -period 15.748 -name sys_clk_pin -waveform {0.000 7.874} -add [get_ports clock_in]
...
set_input_delay -clock [get_clocks *] -min 3.000 [get_ports -filter { NAME =~  "*" && DIRECTION == "IN" }]
set_input_delay -clock [get_clocks *] -max 4.000 [get_ports -filter { NAME =~  "*" && DIRECTION == "IN" }]
