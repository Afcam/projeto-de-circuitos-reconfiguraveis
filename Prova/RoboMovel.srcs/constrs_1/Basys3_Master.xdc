...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports clock_in]

## Switches
set_property PACKAGE_PIN V17 [get_ports {addr_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[0]}]
set_property PACKAGE_PIN V16 [get_ports {addr_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[1]}]
set_property PACKAGE_PIN W16 [get_ports {addr_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[2]}]
set_property PACKAGE_PIN W17 [get_ports {addr_in[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[3]}]
set_property PACKAGE_PIN W15 [get_ports {addr_in[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[4]}]
set_property PACKAGE_PIN V15 [get_ports {addr_in[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[5]}]
set_property PACKAGE_PIN W14 [get_ports {addr_in[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[6]}]

# set_property PACKAGE_PIN W13 [get_ports {BIN_B[3]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_B[3]}]
#
# set_property PACKAGE_PIN V2 [get_ports {BIN_C[0]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_C[0]}]
# set_property PACKAGE_PIN T3 [get_ports {BIN_C[1]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_C[1]}]
# set_property PACKAGE_PIN T2 [get_ports {BIN_C[2]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_C[2]}]
# set_property PACKAGE_PIN R3 [get_ports {BIN_C[3]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_C[3]}]
#
# set_property PACKAGE_PIN W2 [get_ports {BIN_D[0]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_D[0]}]
# set_property PACKAGE_PIN U1 [get_ports {BIN_D[1]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_D[1]}]
# set_property PACKAGE_PIN T1 [get_ports {BIN_D[2]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_D[2]}]

set_property PACKAGE_PIN R2 [get_ports sw_in]
...
#set_property PACKAGE_PIN V7 [get_ports segment_out[7]]
#	set_property IOSTANDARD LVCMOS33 [get_ports segment_out[7]]

#set_property PACKAGE_PIN U2 [get_ports {anado_out[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {anado_out[0]}]
#set_property PACKAGE_PIN U4 [get_ports {anado_out[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {anado_out[1]}]
#set_property PACKAGE_PIN V4 [get_ports {anado_out[2]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {anado_out[2]}]
#set_property PACKAGE_PIN W4 [get_ports {anado_out[3]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {anado_out[3]}]
