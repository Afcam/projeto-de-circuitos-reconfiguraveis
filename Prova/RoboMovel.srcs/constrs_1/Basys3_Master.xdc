...
# set_property PACKAGE_PIN V16 [get_ports {BIN_A[1]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_A[1]}]
# set_property PACKAGE_PIN W16 [get_ports {BIN_A[2]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_A[2]}]
# set_property PACKAGE_PIN W17 [get_ports {BIN_A[3]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_A[3]}]
#
# set_property PACKAGE_PIN W15 [get_ports {BIN_B[0]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_B[0]}]
# set_property PACKAGE_PIN V15 [get_ports {BIN_B[1]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_B[1]}]
# set_property PACKAGE_PIN W14 [get_ports {BIN_B[2]}]
# 	set_property IOSTANDARD LVCMOS33 [get_ports {BIN_B[2]}]
